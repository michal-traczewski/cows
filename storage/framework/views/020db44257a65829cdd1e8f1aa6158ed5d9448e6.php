<div class="jumbotron film-box--detail">
    <a href="/films/details/id/<?php echo e($film->film_id); ?>"><img src="/images/films/<?php echo e($film->film_id); ?>.jpg" width="100" height="100"/></a>
    <div class="title"><?php echo e(ucfirst($film->title)); ?></div> 
